...
export default function HeroSection() {
	return (
		<section className={styles.heroSectionBlock}>
			<div className={styles.heroSection}>
				<div className={styles.container}>
					<div className={styles.features}>
						<div className={styles.feature}>
							<h2 className={styles.featureSubTitle}>Эксклюзивные мероприятия</h2>
							<p className={styles.featureDescription}>Участвуйте в закрытых встречах и событиях для членов
								сообщества</p>
						</div>
						<div className={styles.feature}>
						...
						<div className={styles.feature}>
							...
							<p className={styles.featureDescription}>Заводите полезные знакомства с другими предпринимателями и
								путешественниками</p>
						</div>
					</div>
					...
					<div className={styles.mainContent}>
						...
						<h1 className={styles.title}>
							Присоединяйтесь к сети предпринимателей и путешественников, которые ценят комфорт, стиль и новые
							возможности
						</h1>
